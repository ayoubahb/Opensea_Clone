...
if(isset($_POST['submit'])){
  ...
  $sql="insert into `artist` (name,email,password,artist_img)
  values('$name','$email','$password','$folder')";
					...
					<ul class="navbar-nav my-3 w-50 justify-content-between">
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li>
									<a class="dropdown-item" href="./login.php">Your NFTs</a>
								</li>
							</ul>
						</li>
					</ul>
					<a href="login.php">
						<button class="main-btn">Login in</button>
					</a>
				</div>
			</div>
		</nav>
